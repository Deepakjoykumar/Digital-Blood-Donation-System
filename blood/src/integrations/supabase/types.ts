  ...
  public: {
    Tables: {
      ...
      donation_notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "donation_notifications_donor_id_fkey"
            columns: ["donor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "donation_notifications_responded_by_fkey"
    ...
    Enums: {
      ...
      donation_status: "pending" | "approved" | "rejected" | "completed"
